...
def tag_detect_node():
    ...
    aruco_filtered_pose_pub = rospy.Publisher("/icarus/command/pose", PoseStamped, queue_size=10)
    aruco_tag_sub = rospy.Subscriber("/icarus/object/pose",PoseStamped, tag_detection_cb)
    rospy.spin()
